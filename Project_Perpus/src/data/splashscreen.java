...
public class splashscreen extends javax.swing.JFrame {
    ...
    public splashscreen() {
        initComponents();
        try {
            BufferedImage beam = ImageIO.read(getClass().getResource(""));
            setIconImage(beam);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sedang Loading ....");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 2, 740, 520));
